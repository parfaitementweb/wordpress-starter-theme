    ...
    <div class="flex items-center">
        <div class="container mx-auto py-12 flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            ...
            <div class="max-w-md">
                ...
                <a href="<?php echo home_url() ?>" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-cerise bg-cerise-600 active:bg-cerise-600 hover:bg-cerise-700">Back to homepage</a>
            </div>
        </div>
    </div>
